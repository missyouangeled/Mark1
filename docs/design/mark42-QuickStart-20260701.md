...
| 时间 | passed / skipped | 覆盖率 | 备注 |
|---|---:|---:|---|
| 2026-07-01 15:46 | 700 / 2 | **97.5%** | 本轮补齐 engine/armor/heavy/cli/code_compressor 之后 |
| 2026-07-01 13:39 | 526 / 2 | 74.7% | 上午 7 点左右测试补强完成后 |
| 2026-07-01 09:30 | 316 / 8 | 45.9% | 上午 9 点左右严格审查刚完成时 |

> 如果你要看**当前最新测试口径**，请以：
> - `docs/design/mark42-测试覆盖接力开发方向-20260701.md`
> - `docs/design/mark42-更新日志.md`（看 #30 → #34）
> 为准。
