...
> 上一版：[mark42-压缩方案-阶段1实施计划-20260624.md](./_archive/mark42-压缩方案-阶段1实施计划-20260624.md)（已归档, Day 1-4 实施计划参考）
...
│       └── cli.py                         # CLI 子命令
├── docs/design/
│   ├── mark42-压缩方案借鉴Headroom-20260624.md     # 整体设计（Day 0, 已落地）
│   ├── _archive/mark42-压缩方案-阶段1实施计划-20260624.md  # Day 1-4 实施计划（已归档）
...
4. `docs/design/mark42-压缩方案借鉴Headroom-20260624.md` ← 整体设计（已落地）
5. `docs/design/_archive/mark42-压缩方案-阶段1实施计划-20260624.md` ← Day 1-4 实施计划（已归档）
