...
| `mark42-压缩方案借鉴Headroom-20260624.md` | 🧩 压缩方案 | 借鉴 Headroom 6 大算法到 Mark42 铠甲的 3 阶段路线（设计灵感来源，已落地） |
...
| `审查报告/` | 🔍 审查存档 | 历史审查报告 |
| **`.learnings/ERRORS.md` ERR-001~005** | ⚠️ 测试相关 bug | 写新测试前看（5 个测试设计陷阱） |

## 📦 Archive（已归档，不再维护）

> 以下文档已过时或被取代，但仍保留供历史追溯。
> **不引用、不更新**，需要时请直接读新文档。

| 文档 | 归档原因 | 替代文档 |
|:---|:---|:---|
| `_archive/mark42-Phase2路线-20260625.md` | 已被 20260629 版本取代 | [`mark42-Phase2路线-20260629.md`](./mark42-Phase2路线-20260629.md) |
| `_archive/mark42-阶段1收官README-20260625.md` | 描述 Day 1-8，未包含测试体系/bug 修复 | [`mark42-测试体系-Phase1收官-20260629.md`](./mark42-测试体系-Phase1收官-20260629.md) |
| `_archive/mark42-压缩方案-阶段1实施计划-20260624.md` | 标注"未动手"，实际已全部完成 | [`mark42-开发手册-压缩子系统.md`](./mark42-开发手册-压缩子系统.md) |
