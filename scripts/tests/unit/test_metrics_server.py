...
from mark42_modules.metrics_server import (
    MetricsServer,
    _collect_metrics,
    run_server,
)
...
class TestMetricsGeneration:
    ...
    def test_metrics_contains_context_metrics(self):
        ...
        with patch("mark42_modules.metrics_server.armor_check" if False else "mark42_modules.armor.armor_check") as mock_check:
            ...
            from mark42_modules.metrics_server import _collect_metrics
    ...
    def test_metrics_contains_compress_stats(self):
        ...
        with patch("mark42_modules.armor.armor_llm_stats") as mock_stats:
