...
from mark42_modules.code_analyzer import (
    CodeBug,
    AnalysisResult,
    CodeAnalyzer,
    cli_analyze_code,
...
class TestCodeAnalyzer:
    ...
    def test_code_analyzer_init_default(self):
        """测试默认初始化。"""
        with patch('mark42_modules.code_analyzer.load_config') as mock_load:
            with patch('mark42_modules.code_analyzer.build_consciousness') as mock_build:
    ...
    @patch('mark42_modules.code_analyzer.Path.exists')
    ...
    @patch('mark42_modules.code_analyzer.Path.exists')
    @patch('mark42_modules.code_analyzer.Path.read_text')
...
class TestCLI:
    ...
    @patch('mark42_modules.code_analyzer.build_consciousness')
