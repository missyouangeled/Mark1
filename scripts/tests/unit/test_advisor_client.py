...
class TestAdvisorVerdict:
    ...
    def test_can_create_approve(self):
        from mark42_modules.advisor_client import AdvisorVerdict
...
class TestAdvisorResult:
    ...
    def test_should_ask_user_when_not_success(self):
        from mark42_modules.advisor_client import AdvisorResult
...
class TestAdvisorClientInit:
    ...
    def test_init_with_default_config(self):
        from mark42_modules.advisor_client import AdvisorClient

        with patch("mark42_modules.advisor_client.build_advisor", return_value=MagicMock()):
    ...
    def test_disabled_when_no_advisor_config(self):
        ...
        cfg = {"mark42": {}}
        with patch("mark42_modules.advisor_client.build_advisor", return_value=None):
...
class TestAdvisorClientAsk:
    ...
    def _make_client(self, enabled=True):
        ...
        with patch("mark42_modules.advisor_client.build_advisor", return_value=mock_provider):
            client = AdvisorClient(cfg)
...
class TestCliAdvisor:
    ...
    def test_cli_advisor_status(self):
        from mark42_modules.advisor_client import cli_advisor_status
    ...
    def test_cli_advisor_test(self):
        from mark42_modules.advisor_client import cli_advisor_test
        ...
        with patch("mark42_modules.advisor_client.AdvisorClient.ping") as mock_ping:
            from mark42_modules.advisor_client import AdvisorResult, AdvisorVerdict
    ...
    def test_cli_advisor_ask(self):
        from mark42_modules.advisor_client import cli_advisor_ask
        ...
        with patch("mark42_modules.advisor_client.AdvisorClient.ask_about_uncertain_issue") as mock_ask:
            from mark42_modules.advisor_client import AdvisorResult, AdvisorVerdict
