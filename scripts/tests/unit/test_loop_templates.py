...
from mark42_modules.config import LOOP_TEMPLATES_PATH, USER_LOOP_TEMPLATES_PATH
...
"""
        ...
        mocker.patch("mark42_modules.config.USER_LOOP_TEMPLATES_PATH", user_yaml_path)
...
class TestEngineRunLoopGeneric:
    ...
    def test_custom_template_uses_generic_path(self, mocker, capsys):
        ...
        mocker.patch("mark42_modules.engine._append_broker")
