...
from mark42_modules.anomaly_detector import (
    AnomalyAlert,
    MetricSample,
    ThresholdDetector,
    ZScoreDetector,
...
class TestAnomalyDetector:
    ...
    @patch('mark42_modules.anomaly_detector.shutil.disk_usage')
    @patch('mark42_modules.anomaly_detector.open', new_callable=mock_open, read_data='MemAvailable: 1048576 kB\n')
