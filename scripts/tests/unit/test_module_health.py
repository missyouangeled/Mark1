...
# 导入待测试模块
from scripts.mark42_modules.module_health import (
    ModuleHealth,
    ModuleHealthMonitor,
)
...
class TestModuleHealthMonitor:
    ...
    def test_check_armor_module(self, mocker):
        ...
        sys.modules["scripts.mark42_modules.armor"] = mock_armor_module
    ...
    def test_check_engine_module_with_active_loops(self, mocker):
        ...
        sys.modules["scripts.mark42_modules.engine"] = mock_engine_module
    ...
    def test_check_consciousness_module_healthy(self, mocker):
        ...
        sys.modules["scripts.mark42_modules.consciousness"] = mock_cons_module
    ...
    def test_check_advisor_module_disabled(self, mocker):
        ...
        sys.modules["scripts.mark42_modules.advisor_client"] = mock_advisor_module
    ...
    def test_check_error_archive_module(self, mocker):
        ...
        sys.modules["scripts.mark42_modules.error_archive"] = mock_archive_module
