...
class TestProtocols:
    ...
    def test_compress_lock_protocol(self):
        from mark42_modules.interfaces.compress import CompressLock
    ...
    def test_memory_lock_protocol(self):
        from mark42_modules.interfaces.memory import MemoryLock
    ...
    def test_consciousness_lock_protocol(self):
        from mark42_modules.interfaces.consciousness import ConsciousnessLock
    ...
    def test_archive_lock_protocol(self):
        from mark42_modules.interfaces.error_archive import ArchiveLock
    ...
    def test_breaker_lock_protocol(self):
        from mark42_modules.interfaces.circuit_breaker import BreakerLock
    ...
    def test_health_lock_protocol(self):
        from mark42_modules.interfaces.health import HealthLock
    ...
    def test_engine_lock_protocol(self):
        from mark42_modules.interfaces.engine import EngineLock
    ...
    def test_chaos_lock_protocol(self):
        from mark42_modules.interfaces.chaos import ChaosLock
    ...
    def test_heavy_lock_protocol(self):
        from mark42_modules.interfaces.heavy import HeavyLock
...
class TestRegistry:
    ...
    def test_register_and_get(self):
        from mark42_modules.interfaces import register, get, _REGISTRY
    ...
    def test_get_unknown_returns_none(self):
        from mark42_modules.interfaces import get
    ...
    def test_list_all(self):
        from mark42_modules.interfaces import list_all
    ...
    def test_get_compress_returns_object(self):
        ...
        from mark42_modules.interfaces import get_compress
    ...
    def test_configure_from_file_missing_file(self):
        """配置文件不存在时不应崩溃。"""
        from mark42_modules.interfaces import configure_from_file
...
class TestBuiltinPlugins:
    ...
    def test_builtin_compress_loads(self):
        from mark42_modules.plugins.builtin_compress import BuiltinCompress
    ...
    def test_builtin_memory_loads(self):
        from mark42_modules.plugins.builtin_memory import BuiltinMemory
    ...
    def test_builtin_consciousness_loads(self):
        from mark42_modules.plugins.builtin_consciousness import BuiltinConsciousness
    ...
    def test_builtin_archive_loads(self):
        from mark42_modules.plugins.builtin_archive import BuiltinArchive
    ...
    def test_builtin_breaker_loads(self):
        from mark42_modules.plugins.builtin_breaker import BuiltinBreaker
    ...
    def test_builtin_health_loads(self):
        from mark42_modules.plugins.builtin_health import BuiltinHealth

        impl = BuiltinHealth()
        assert hasattr(impl, "check_health")

    def test_builtin_engine_loads(self):
        from mark42_modules.plugins.builtin_engine import BuiltinEngine
    ...
    def test_builtin_chaos_loads(self):
        from mark42_modules.plugins.builtin_chaos import BuiltinChaos
    ...
    def test_builtin_heavy_loads(self):
        from mark42_modules.plugins.builtin_heavy import BuiltinHeavy
...
class TestModuleIntegration:
    ...
    def test_consciousness_uses_get_compress(self):
        ...
        import inspect
        from mark42_modules import consciousness
...
class TestArcLockConfig:
    ...
    def test_empty_yaml(self, tmp_path):
        """空配置文件 -> 全部用默认。"""
        from mark42_modules.interfaces import configure_from_file, _REGISTRY
...
''')
            ...
            from mark42_modules.interfaces import configure_from_file, get, _REGISTRY
