...
class TestCoreDefinitions:
    ...
    def test_definitions_is_list(self):
        from mark42_modules.core_registry import CORE_DEFINITIONS
...
class TestCoreRegistryInit:
    ...
    def test_init_creates_default_cores(self, tmp_path):
        from mark42_modules import core_registry
        reg_dir = tmp_path / "core-registry"
        reg_dir.mkdir(parents=True, exist_ok=True)

        with patch("mark42_modules.core_registry.REGISTRY_DIR", reg_dir):
            with patch("mark42_modules.core_registry.REGISTRY_FILE", reg_dir / "registry.json"):
...
class TestProbeCore:
    ...
    def test_probe_nonexistent_core(self):
        from mark42_modules.core_registry import probe_core
    ...
    def test_probe_core_1_main_consciousness(self):
        ...
        with patch("mark42_modules.core_registry._probe_http", return_value=True):
    ...
    def test_probe_core_1_main_consciousness_down(self):
        ...
        with patch("mark42_modules.core_registry._probe_http", return_value=False):
            result = probe_core("core_1_main_consciousness")
...
class TestCliCores:
    ...
    def test_cli_cores_list(self, tmp_path):
        ...
        with patch("mark42_modules.core_registry.REGISTRY_DIR", reg_dir):
            with patch("mark42_modules.core_registry.REGISTRY_FILE", reg_dir / "registry.json"):
                from mark42_modules.core_registry import cli_cores_list
...
class TestHelperFunctions:
    ...
    def test_probe_http_success(self):
        from mark42_modules.core_registry import _probe_http
    ...
    def test_probe_systemd_active(self):
        from mark42_modules.core_registry import _probe_systemd
