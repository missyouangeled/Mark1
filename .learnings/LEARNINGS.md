...
**Logged**: 2026-07-17T05:35:22.021Z
**Priority**: high
**Status**: pending
**Area**: docs
...
### Details
Correction Signal: 好 我想问 GLM-5.2 应该是多模态 模型 为什么只注册文本模型 ？ 看看其他的能不能也用到这个。 doubao也一样。
...
**Logged**: 2026-07-24T04:57:26.660Z
**Priority**: high
**Status**: pending
**Area**: docs
...
### Details
Correction Signal: 那如果说我自己微调一个 开源大模型，不是说训练他学会各种知识，而是把每次对话喂给他。结果会怎么样。
...
## [LRN-20260728-003] correction

**Logged**: 2026-07-28T04:53:34.543Z
**Priority**: high
**Status**: pending
**Area**: docs
...
### Details
Correction Signal: 把图像识别模型 换成豆包。 豆包 应该是能识别图像 对吧。
...
## [LRN-20260728-004] correction

**Logged**: 2026-07-28T08:46:02.651Z
**Priority**: high
**Status**: pending
**Area**: docs
...
### Details
Correction Signal: 应该是重启完了，看看是否都正常运行了。
