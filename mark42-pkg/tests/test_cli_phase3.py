...
class TestArchiveCli:
    def test_archive_list(self, mocker, capsys):
        """archive list 正常分发。"""
        mock_arc = mocker.patch("mark42.error_archive.ErrorArchive")
...
class TestConsciousnessCli:
    def test_consciousness_check(self, mocker, capsys):
        ...
        mock_cs = mocker.patch("mark42.consciousness.Consciousness")
    ...
    def test_consciousness_eval_missing_args(self, mocker, capsys):
        ...
        mocker.patch("mark42.consciousness.Consciousness")
...
class TestCoresCli:
    def test_cores_list(self, mocker, capsys):
        """cores list 正常分发。"""
        mock_list = mocker.patch("mark42.core_registry.cli_cores_list")
    ...
    def test_cores_probe(self, mocker, capsys):
        """cores probe 正常分发。"""
        mock_probe = mocker.patch("mark42.core_registry.cli_cores_probe")
    ...
    def test_cores_quarantine(self, mocker):
        ...
        mock_q = mocker.patch("mark42.core_registry.cli_cores_quarantine")
    ...
    def test_cores_restore(self, mocker):
        """cores restore 正常分发。"""
        mock_r = mocker.patch("mark42.core_registry.cli_cores_restore")
...
class TestBreakerCli:
    def test_breaker_list_empty(self, mocker, capsys):
        ...
        mock_cb = mocker.patch("mark42.circuit_breaker.CircuitBreaker")
...
class TestContextSafetyCli:
    ...
    def test_context_safety_apply(self, mocker):
        ...
        mock_apply = mocker.patch("mark42.context_safety.context_safety_apply")
    ...
    def test_context_safety_verify(self, mocker):
        ...
        mock_verify = mocker.patch("mark42.context_safety.context_safety_verify")
...
class TestLogsCliExtra:
    def test_logs_rotate(self, mocker):
        """logs --rotate 分发。"""
        mock_rotate = mocker.patch("mark42.logs.log_rotate")
    ...
    def test_logs_status(self, mocker):
        """logs --status 分发。"""
        mock_status = mocker.patch("mark42.logs.log_rotate_status")
...
class TestCostCli:
    def test_cost_today(self, mocker, capsys):
        """cost today 分发。"""
        mock_today = mocker.patch("mark42.cost_tracker.cli_cost_today")
    ...
    def test_cost_month(self, mocker):
        """cost month 分发。"""
        mock_month = mocker.patch("mark42.cost_tracker.cli_cost_month")
    ...
    def test_cost_top(self, mocker):
        """cost top 分发。"""
        mock_top = mocker.patch("mark42.cost_tracker.cli_cost_top")
...
class TestChaosCli:
    def test_chaos_list(self, mocker, capsys):
        """chaos list 分发。"""
        mock_engine = mocker.patch("mark42.chaos_engine.ChaosEngine")
