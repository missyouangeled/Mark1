...
from mark42.llm_provider import ChatMessage
...
class TestCLIInterface(unittest.TestCase):
    ...
    def test_cli_test_success(self):
        ...
        with patch("mark42.advisor_client.build_advisor") as mock_build:
...
class TestEndToEndFlow(unittest.TestCase):
    ...
    def test_system_prompt_contains_json_contract(self):
        ...
        from mark42.advisor_client import ADVISOR_SYSTEM_PROMPT
